...
let aluno1 = new Aluno("Luana", 3, [9, 8, 6, 10]);
let aluno2 = new Aluno("Lucas", 2, [9, 2, 8, 4]);
let aluno3 = new Aluno("Laura", 1, [5, 5, 8, 10]);
let aluno4 = new Aluno("Deborah", 0, [6, 6, 0, 3]);
let aluno5 = new Aluno("Tiago", 3, [8, 7, 6, 8]);
